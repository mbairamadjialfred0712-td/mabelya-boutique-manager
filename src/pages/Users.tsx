...
export default function Users() {
  ...
  const createUser = useMutation({
    mutationFn: async (input: { email: string; password: string; full_name: string; role: AppRole }) => {
...
function CreateUserForm({
  ...
  onSubmit: (data: { email: string; password: string; full_name: string; role: AppRole }) => void;
  loading: boolean;
}) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    onSubmit({ email: form.email, password: form.password, full_name: form.full_name, role: form.role as AppRole });
  };
